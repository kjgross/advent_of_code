...
input_code = ['Sue 1: children: 1, cars: 8, vizslas: 7',
...
for i in input_code:
	if ":" in i:
		name, facts = i.split(":",1)
	facts2 = {}
	for j in facts.split(","):
		facts2[str(j.split(":")[0]).lstrip()] = int(j.split(": ")[1])
	aunts[str(name)] = facts2
